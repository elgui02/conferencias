...
use Umg\ConferenciaBundle\Form\AlumnoType;
...
class AlumnoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UmgConferenciaBundle:Alumno')->findAll();
     ...
     * @Method("POST")
     * @Template("UmgConferenciaBundle:Alumno:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UmgConferenciaBundle:Alumno')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("UmgConferenciaBundle:Alumno:edit.html.twig")
     */
